            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li class="scroll-to-section"><a href="#features">Roadmap</a></li>
                        <li class="scroll-to-section"><a href="#about">About Us</a></li>
                        <li class="scroll-to-section"><a href="#services">Services</a></li>
                        <li class="scroll-to-section"><a href="#portfolio">NFT Marketpalce</a></li>
                        <li class="scroll-to-section"><a href="/chart">Chart</a></li>
                        <li class="scroll-to-section"><div class="main-blue-button"><a href="#contact">BUY TOKEN (Coming soon)</a></div></li>
                    </ul>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <p>Copyright © 2021 SEO Dream Co., Ltd. All Rights Reserved.</p>
            </div>
